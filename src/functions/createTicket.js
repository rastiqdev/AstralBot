...
module.exports = createTicket = async function(interaction) {
    const client = interaction.client

    const category = await interaction.guild.channels.fetch(client.config.ticketCategoryId)
    ...
    const messageData = {
        embeds: [
            new MessageEmbed({
                ...
                description: `Bonjour <@${interaction.user.id}>, voici votre ticket.\n\nVeuillez exprimer **clairement** votre ` +
